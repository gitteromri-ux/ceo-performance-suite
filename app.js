...
(function () {
    ...
    container.innerHTML = `
      <div class="dashboard-view">
        ...
        <div class="exec-summary-banner">
          <div class="exec-summary-title">KEY FINDINGS</div>
          <div class="exec-summary-bullets">
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Rosen months with <strong>≥75% top-rep revenue share averaged $216K net revenue</strong> vs $153K without — a <strong>$63K/mo gap ($763K/yr)</strong></div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Correlation between %top-rep and revenue is <strong>r=0.711 (p&lt;0.01)</strong> — the single strongest predictor of monthly revenue</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Optimal Rosen call volume: <strong>9,500–11,000 calls/month</strong> produces $191K avg net revenue</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> IIBS months with <strong>≥60% top-rep share averaged $259K vs $207K</strong> — a $52K/mo gap ($626K/yr)</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Combined golden rule opportunity: <strong>$115K/mo ($1.39M/yr)</strong> being left on the table</div>
          </div>
        </div>
        ...
        <div class="optimal-thresholds-section">
          <div class="optimal-thresholds-headline">WHICH METRICS ARE OPTIMAL &amp; WHAT WE SHOULD NEVER FALL BELOW</div>
          <div class="optimal-thresholds-subtitle">In the context of: What Minimum Standards Should We Never Fall Below?</div>
          <div class="thresholds-grid">
            <div class="threshold-card">
              <div class="threshold-label">Rosen % Top Rep Share</div>
              <div class="threshold-optimal">Optimal: ≥75%</div>
              <div class="threshold-floor">Never Below: 60%</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">IIBS % Top Rep Share</div>
              <div class="threshold-optimal">Optimal: ≥60%</div>
              <div class="threshold-floor">Never Below: 45%</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Rosen Monthly Calls</div>
              <div class="threshold-optimal">Optimal: 9,500–11,000</div>
              <div class="threshold-floor">Never Below: 8,500</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Rosen Calls / Shift</div>
              <div class="threshold-optimal">Optimal: 20–21</div>
              <div class="threshold-floor">Never Below: 18</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Top Rep Conversion Rate</div>
              <div class="threshold-optimal">Optimal: ≥20%</div>
              <div class="threshold-floor">Never Below: 15%</div>
            </div>
          </div>
        </div>
      </div>
    ...
    container.innerHTML = `
      <div class="dashboard-view">
        ...
        <div class="exec-summary-banner">
          <div class="exec-summary-title">KEY FINDINGS</div>
          <div class="exec-summary-bullets">
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> <strong>68% of month-over-month transitions (17/25)</strong> show inverse movement: when Rosen’s top-rep share rises, IIBS falls</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> <strong>Average 4.7 reps overlap</strong> in both schools’ top lists every month — these reps are being pulled in two directions</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> <strong>Tessler and Tamir appear in both schools’ top lists 20/26 months</strong> — the most cannibalized reps</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> When Rosen hits golden territory (≥75%), IIBS drops below threshold in <strong>70% of those same months</strong></div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Separating dedicated teams would eliminate the zero-sum tug-of-war and unlock <strong>$115K/mo in combined upside</strong></div>
          </div>
        </div>
        ...
        <div class="optimal-thresholds-section">
          <div class="optimal-thresholds-headline">WHICH METRICS ARE OPTIMAL &amp; WHAT WE SHOULD NEVER FALL BELOW</div>
          <div class="optimal-thresholds-subtitle">In the context of: Should We Separate Sales Reps Across Schools?</div>
          <div class="thresholds-grid">
            <div class="threshold-card">
              <div class="threshold-label">Rep Overlap Count</div>
              <div class="threshold-optimal">Optimal: 0–1 reps</div>
              <div class="threshold-floor">Never Above: 3 reps</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Rosen Dedicated Core Reps</div>
              <div class="threshold-optimal">Optimal: 6 reps</div>
              <div class="threshold-floor">Never Below: 4 reps</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">IIBS Dedicated Core Reps</div>
              <div class="threshold-optimal">Optimal: 4–5 reps</div>
              <div class="threshold-floor">Never Below: 3 reps</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Inverse Movement Rate</div>
              <div class="threshold-optimal">Optimal: &lt;30%</div>
              <div class="threshold-floor">Currently: 68% (critical)</div>
            </div>
          </div>
        </div>
      </div>
    ...
    container.innerHTML = `
      <div class="dashboard-view">
        ...
        <div class="exec-summary-banner">
          <div class="exec-summary-title">KEY FINDINGS</div>
          <div class="exec-summary-bullets">
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Rosen CPL averages <strong>$50.0 with 14.0% coefficient of variation</strong> — within acceptable range (&lt;20%)</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> IIBS CPL averages <strong>$24.1 with 18.3% coefficient of variation</strong> — approaching instability threshold</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Month-to-month CPL swings create <strong>lead volume volatility that disrupts call center planning</strong></div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Higher CPL months don’t necessarily produce worse ROI — <strong>rep utilization matters more than lead cost</strong></div>
          </div>
        </div>
        ...
        <div class="optimal-thresholds-section">
          <div class="optimal-thresholds-headline">WHICH METRICS ARE OPTIMAL &amp; WHAT WE SHOULD NEVER FALL BELOW</div>
          <div class="optimal-thresholds-subtitle">In the context of: Are Ad Accounts Too Unstable for Reliable Performance?</div>
          <div class="thresholds-grid">
            <div class="threshold-card">
              <div class="threshold-label">Rosen CPL</div>
              <div class="threshold-optimal">Optimal: $45–$55</div>
              <div class="threshold-floor">Never Above: $65</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">IIBS CPL</div>
              <div class="threshold-optimal">Optimal: $20–$28</div>
              <div class="threshold-floor">Never Above: $35</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">CPL Coefficient of Variation</div>
              <div class="threshold-optimal">Optimal: &lt;15%</div>
              <div class="threshold-floor">Never Above: 25%</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Monthly Lead Budget Variance</div>
              <div class="threshold-optimal">Optimal: &lt;10%</div>
              <div class="threshold-floor">Never Above: 20%</div>
            </div>
          </div>
        </div>
      </div>
    ...
    container.innerHTML = `
      <div class="dashboard-view">
        ...
        <div class="exec-summary-banner">
          <div class="exec-summary-title">KEY FINDINGS</div>
          <div class="exec-summary-bullets">
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Rosen averages <strong>2,338 leads/mo with range 1,870–3,385</strong> — high variance destabilizes call planning</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> At optimal <strong>4.0–5.0 calls/lead</strong>, Rosen needs minimum <strong>2,000 leads/mo</strong> to maintain call volume standards</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> IIBS averages <strong>6,785 leads/mo</strong> — more stable volume but quality varies significantly</div>
            <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Lead shortfall months directly correlate with below-threshold revenue: <strong>every 100 leads short costs approximately $8K in net revenue</strong></div>
          </div>
        </div>
        ...
        <div class="optimal-thresholds-section">
          <div class="optimal-thresholds-headline">WHICH METRICS ARE OPTIMAL &amp; WHAT WE SHOULD NEVER FALL BELOW</div>
          <div class="optimal-thresholds-subtitle">In the context of: Are We Hitting Lead Targets? What’s the Revenue Cost?</div>
          <div class="thresholds-grid">
            <div class="threshold-card">
              <div class="threshold-label">Rosen Monthly Leads</div>
              <div class="threshold-optimal">Optimal: 2,200–2,600</div>
              <div class="threshold-floor">Never Below: 1,900</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">IIBS Monthly Leads</div>
              <div class="threshold-optimal">Optimal: 6,000–8,000</div>
              <div class="threshold-floor">Never Below: 5,000</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Rosen Calls / Lead</div>
              <div class="threshold-optimal">Optimal: 4.0–5.0</div>
              <div class="threshold-floor">Never Above: 6.0 / Never Below: 3.5</div>
            </div>
            <div class="threshold-card">
              <div class="threshold-label">Lead-to-Revenue Efficiency</div>
              <div class="threshold-optimal">Optimal: &gt;$75/lead</div>
              <div class="threshold-floor">Never Below: $50/lead</div>
            </div>
          </div>
        </div>
      </div>
  ...
  function renderInit5() {
    container.innerHTML = `<div class="dashboard-view">
      ...
      <div class="exec-summary-banner">
        <div class="exec-summary-title">KEY FINDINGS</div>
        <div class="exec-summary-bullets">
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Current model: <strong>Rosen $50 CPL, IIBS $24 CPL</strong> — pilot targets <strong>$25 CPL</strong></div>
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> At $25 CPL, same budget buys <strong>2x the leads</strong> but conversion rate likely drops</div>
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Break-even requires <strong>≥50% of current conversion efficiency</strong> at the lower CPL</div>
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Pilot plan: <strong>25% of media budget with new reps</strong> (not pulling core reps)</div>
        </div>
      </div>
      ...
      <div class="optimal-thresholds-section">
        <div class="optimal-thresholds-headline">WHICH METRICS ARE OPTIMAL &amp; WHAT WE SHOULD NEVER FALL BELOW</div>
        <div class="optimal-thresholds-subtitle">In the context of: Can a Low-CPL LeadGen Model Deliver Better ROI?</div>
        <div class="thresholds-grid">
          <div class="threshold-card">
            <div class="threshold-label">Pilot CPL Target</div>
            <div class="threshold-optimal">Optimal: $25</div>
            <div class="threshold-floor">Never Above: $32 (pilot validity breaks)</div>
          </div>
          <div class="threshold-card">
            <div class="threshold-label">Minimum Acceptable Conversion</div>
            <div class="threshold-optimal">Optimal: 8%+</div>
            <div class="threshold-floor">Never Below: 5% (break-even)</div>
          </div>
          <div class="threshold-card">
            <div class="threshold-label">Pilot Budget Allocation</div>
            <div class="threshold-optimal">Optimal: 25% of media budget</div>
            <div class="threshold-floor">Never Exceed: 40% until proven</div>
          </div>
          <div class="threshold-card">
            <div class="threshold-label">Break-even Rev / Lead</div>
            <div class="threshold-optimal">Optimal: &gt;$50/lead</div>
            <div class="threshold-floor">Never Below: $37/lead</div>
          </div>
        </div>
      </div>
    </div>`;
  ...
  function renderInit6() {
    container.innerHTML = `<div class="dashboard-view">
      ...
      <div class="exec-summary-banner">
        <div class="exec-summary-title">KEY FINDINGS</div>
        <div class="exec-summary-bullets">
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Every shift generates positive margin: Rosen <strong>$158/shift</strong>, IIBS <strong>$180/shift</strong> — weekend shifts are pure upside</div>
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Saturday runs at ~80% weekday capacity; Sunday has <strong>zero coverage</strong> — estimated 15-20% of weekly opportunity lost</div>
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> Adding full weekend coverage at current margins = <strong>+$48K/month ($576K/year)</strong> at near-zero incremental cost</div>
          <div class="exec-bullet"><span class="exec-bullet-icon">●</span> <strong>No new hires, no technology, no budget increase</strong> — requires only scheduling changes with existing reps</div>
        </div>
      </div>
      ...
      <div class="optimal-thresholds-section">
        <div class="optimal-thresholds-headline">WHICH METRICS ARE OPTIMAL &amp; WHAT WE SHOULD NEVER FALL BELOW</div>
        <div class="optimal-thresholds-subtitle">In the context of: How Much Revenue Are We Losing on Weekends?</div>
        <div class="thresholds-grid">
          <div class="threshold-card">
            <div class="threshold-label">Saturday Coverage</div>
            <div class="threshold-optimal">Optimal: 100%</div>
            <div class="threshold-floor">Never Below: 80%</div>
          </div>
          <div class="threshold-card">
            <div class="threshold-label">Sunday Coverage</div>
            <div class="threshold-optimal">Optimal: 50-75%</div>
            <div class="threshold-floor">Currently: 0%</div>
          </div>
          <div class="threshold-card">
            <div class="threshold-label">Weekend Margin/Shift</div>
            <div class="threshold-optimal">Optimal: ≥$150</div>
            <div class="threshold-floor">Never Below: $120</div>
          </div>
          <div class="threshold-card">
            <div class="threshold-label">Weekend Rep Quality</div>
            <div class="threshold-optimal">Optimal: Core reps only</div>
            <div class="threshold-floor">Never: Backfill only</div>
          </div>
        </div>
      </div>
    </div>`;
  ...
  function renderStandards() {
    ...
    container.innerHTML = `
      <div class="dashboard-view">
        ...
        ${subTabs(["Rosen", "IIBS", "3-Way Analysis", "4-Way Optimum", "Top Revenue"])}
  ...
  // ===========================================================================
  // STANDARDS: 3-WAY ANALYSIS
  // ===========================================================================
  function render3WayAnalysis() {
    const content = document.getElementById("standardsContent");

    // ── Data preparation ──
    // Rosen CPL = calls/leads; IIBS CPL = calls/leads
    // For Rosen: pct_contacted is available directly
    // For IIBS: pct_contacted ≈ 100% (all leads get a call); use conv as meaningful conversion metric
    const rosenData = CALL_STATS.rosen.map(m => ({
      school: "Rosen",
      month: m.short,
      leads: m.leads,
      cpl: m.calls / m.leads,
      pct_contacted: m.pct_contacted,
      revenue: m.net_sc,
    }));
    const iibsData = CALL_STATS.iibs.map(m => ({
      school: "IIBS",
      month: m.short,
      leads: m.leads,
      cpl: m.calls / m.leads,
      pct_contacted: m.conv,   // For IIBS: conv% is the meaningful rate (acq/leads*100)
      revenue: m.net_sc,
    }));
    const allData = [...rosenData, ...iibsData];

    // ── CPL band classifier ──
    function getCplBand(cpl, school) {
      if (school === "Rosen") {
        if (cpl < 3.7)  return "Low (3.0–3.7)";
        if (cpl < 4.3)  return "Mid (3.7–4.3)";
        if (cpl < 5.0)  return "Sweet (4.3–5.0)";
        return "High (5.0+)";
      } else {
        if (cpl < 4.5)  return "Low (4.0–4.5)";
        if (cpl < 5.2)  return "Mid (4.5–5.2)";
        if (cpl < 5.8)  return "Sweet (5.2–5.8)";
        return "High (5.8+)";
      }
    }

    // ── Lead bucket classifier ──
    function getLeadBucket(leads, school) {
      if (school === "Rosen") {
        if (leads < 2100)  return "1800–2100";
        if (leads < 2400)  return "2100–2400";
        if (leads < 2700)  return "2400–2700";
        if (leads < 3000)  return "2700–3000";
        return "3000+";
      } else {
        if (leads < 5500)   return "4500–5500";
        if (leads < 6500)   return "5500–6500";
        if (leads < 7500)   return "6500–7500";
        if (leads < 8500)   return "7500–8500";
        return "8500+";
      }
    }

    const rosenCplBuckets = ["Low (3.0–3.7)", "Mid (3.7–4.3)", "Sweet (4.3–5.0)", "High (5.0+)"];
    const iibsCplBuckets  = ["Low (4.0–4.5)", "Mid (4.5–5.2)", "Sweet (5.2–5.8)", "High (5.8+)"];
    const rosenLeadBuckets = ["1800–2100", "2100–2400", "2400–2700", "2700–3000", "3000+"];
    const iibsLeadBuckets  = ["4500–5500", "5500–6500", "6500–7500", "7500–8500", "8500+"];

    // ── Build heatmap data for one school ──
    function buildHeatmap(rows, leadBuckets, cplBuckets, school) {
      const cells = [];
      leadBuckets.forEach(lb => {
        cplBuckets.forEach(cb => {
          const pts = rows.filter(m => getLeadBucket(m.leads, school) === lb && getCplBand(m.cpl, school) === cb);
          if (pts.length > 0) {
            cells.push({
              lead_bucket: lb,
              cpl_bucket: cb,
              avg_contacted: avg(pts.map(p => p.pct_contacted)),
              avg_revenue: avg(pts.map(p => p.revenue)),
              count: pts.length,
            });
          } else {
            cells.push({ lead_bucket: lb, cpl_bucket: cb, avg_contacted: 0, avg_revenue: 0, count: 0 });
          }
        });
      });
      return cells;
    ...
    const rosenHeat = buildHeatmap(rosenData, rosenLeadBuckets, rosenCplBuckets, "Rosen");
    const iibsHeat  = buildHeatmap(iibsData,  iibsLeadBuckets,  iibsCplBuckets,  "IIBS");

    // ── Find optimal cell for each school ──
    function findOptimal(cells) {
      return cells.filter(c => c.count > 0).reduce((best, c) =>
        c.avg_contacted > best.avg_contacted ? c : best,
        { avg_contacted: -Infinity, avg_revenue: 0, lead_bucket: "—", cpl_bucket: "—", count: 0 }
      );
    }
    const rosenOpt = findOptimal(rosenHeat);
    const iibsOpt  = findOptimal(iibsHeat);

    // ── Heat color helper ──
    function heatColor(val, maxVal) {
      const t = maxVal > 0 ? Math.min(val / maxVal, 1) : 0;
      if (t < 0.25) return { bg: "rgba(239,68,68,0.25)",  text: "#fca5a5" };
      if (t < 0.5)  return { bg: "rgba(245,158,11,0.25)", text: "#fcd34d" };
      if (t < 0.75) return { bg: "rgba(99,102,241,0.30)", text: "#a5b4fc" };
      return { bg: "rgba(16,185,129,0.35)", text: "#6ee7b7" };
    }

    // ── Build heatmap HTML ──
    function buildHeatmapHTML(cells, leadBuckets, cplBuckets, optCell, metricLabel) {
      const maxVal = Math.max(...cells.filter(c => c.count > 0).map(c => c.avg_contacted), 0.001);
      let html = `<div style="overflow-x:auto"><table class="heatmap-table"><thead><tr><th>Leads \\ CPL</th>`;
      cplBuckets.forEach(cb => { html += `<th>${cb}</th>`; });
      html += `</tr></thead><tbody>`;
      leadBuckets.forEach(lb => {
        html += `<tr><th style="text-align:right;padding-right:12px;white-space:nowrap">${lb}</th>`;
        cplBuckets.forEach(cb => {
          const cell = cells.find(c => c.lead_bucket === lb && c.cpl_bucket === cb);
          if (cell && cell.count > 0) {
            const colors = heatColor(cell.avg_contacted, maxVal);
            const isOpt = cell.lead_bucket === optCell.lead_bucket && cell.cpl_bucket === optCell.cpl_bucket;
            html += `<td class="heatmap-cell${isOpt ? " optimal" : ""}" style="background:${colors.bg};color:${colors.text}">
              <span class="cell-main">${cell.avg_contacted.toFixed(1)}%</span>
              <span class="cell-sub">${fmtK(cell.avg_revenue)} &middot; ${cell.count}m</span>
            </td>`;
          } else {
            html += `<td class="heatmap-cell" style="background:rgba(255,255,255,0.02);color:var(--color-text-tertiary)">
              <span class="cell-main">&mdash;</span>
              <span class="cell-sub">0 mo</span>
            </td>`;
          }
        });
        html += `</tr>`;
    ...
    // ── KPI values ──
    const rContactedLabel = "Best %Contacted";
    const iContactedLabel = "Best Conv%";
    const rosenContactedFmt = rosenOpt.avg_contacted.toFixed(1) + "%";
    const iibsContactedFmt  = iibsOpt.avg_contacted.toFixed(2) + "%";

    content.innerHTML = `
      ${initKpiRow([
        { label: "Rosen Optimal Lead Band", value: rosenOpt.lead_bucket, sub: "For highest contacted%", cls: "accent-green" },
        { label: "Rosen Optimal CPL Band",  value: rosenOpt.cpl_bucket,  sub: "Highest contact zone" },
        { label: "Rosen Best %Contacted",   value: rosenContactedFmt,   sub: fmtK(rosenOpt.avg_revenue) + " avg rev" },
        { label: "IIBS Optimal Lead Band",  value: iibsOpt.lead_bucket,  sub: "For highest conv%", cls: "accent-green" },
        { label: "IIBS Best Conv%",         value: iibsContactedFmt,    sub: fmtK(iibsOpt.avg_revenue) + " avg rev" },
      ])}

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">Rosen — Lead Band &times; CPL Band Heatmap (%Contacted)</div>
          <div class="heatmap-container" id="std3heatR"></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">IIBS — Lead Band &times; CPL Band Heatmap (Conv%)</div>
          <div class="heatmap-container" id="std3heatI"></div>
        </div>
      </div>

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">Rosen — CPL vs %Contacted (bubble = lead volume)</div>
          <div class="chart-wrap" style="height:320px"><canvas id="std3bubR"></canvas></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">IIBS — CPL vs Conv% (bubble = lead volume)</div>
          <div class="chart-wrap" style="height:320px"><canvas id="std3bubI"></canvas></div>
        </div>
      </div>

      <div class="verdict-banner">
        <div class="verdict-label">3-WAY ANALYSIS INSIGHT</div>
        <div class="verdict-text" id="std3insight"></div>
      </div>
    `;

    // Inject heatmaps
    document.getElementById("std3heatR").innerHTML = buildHeatmapHTML(rosenHeat, rosenLeadBuckets, rosenCplBuckets, rosenOpt, "%Contacted");
    document.getElementById("std3heatI").innerHTML = buildHeatmapHTML(iibsHeat,  iibsLeadBuckets,  iibsCplBuckets,  iibsOpt,  "Conv%");

    // ── Bubble chart helper ──
    function makeBubble(rows, school, canvasId, xLabel, yLabel) {
      const maxLeads = Math.max(...rows.map(r => r.leads));
      const cplBands = school === "Rosen" ? rosenCplBuckets : iibsCplBuckets;
      const bandColors = [C.emerald, C.indigo, C.amber, C.red];
      const datasets = cplBands.map((band, idx) => {
        const pts = rows.filter(r => getCplBand(r.cpl, school) === band);
        return {
          label: band,
          data: pts.map(r => ({ x: r.cpl, y: r.pct_contacted, r: Math.max(4, (r.leads / maxLeads) * 22), leads: r.leads, month: r.month, revenue: r.revenue })),
          backgroundColor: bandColors[idx] + "44",
          borderColor: bandColors[idx],
          borderWidth: 1.5,
        };
      });
      mkChart(canvasId, {
        ...
        options: {
          ...
          maintainAspectRatio: false,
          plugins: {
            legend: { display: true, labels: { color: C.textSec, font: { size: 10, family: "Inter" }, usePointStyle: true } },
            tooltip: {
              ...baseTooltip,
              callbacks: {
                label: ctx => [
                  ctx.dataset.label,
                  `CPL: ${ctx.raw.x.toFixed(2)}`,
                  `${yLabel}: ${ctx.raw.y.toFixed(1)}%`,
                  `Leads: ${ctx.raw.leads}`,
                  `Rev: ${fmtK(ctx.raw.revenue)}`,
                  `Month: ${ctx.raw.month}`,
                ],
              },
            },
          ...
          scales: {
            x: { ...baseScaleX, type: "linear", title: { display: true, text: xLabel, color: C.textMuted, font: { size: 10 } } },
            y: { ...baseScaleY(yLabel), ticks: { ...baseScaleY("").ticks, callback: v => v + "%" } },
          },
        },
      });
    }

    makeBubble(rosenData, "Rosen", "std3bubR", "Calls per Lead", "%Contacted");
    makeBubble(iibsData,  "IIBS",  "std3bubI", "Calls per Lead", "Conv%");

    // ── Insight text ──
    document.getElementById("std3insight").innerHTML =
      `<strong>Rosen:</strong> Optimal zone is <strong>${rosenOpt.lead_bucket}</strong> leads × <strong>${rosenOpt.cpl_bucket}</strong> CPL &mdash; ` +
      `highest contacted rate ${rosenContactedFmt}, avg revenue ${fmtK(rosenOpt.avg_revenue)} (${rosenOpt.count} months). ` +
      `<strong>IIBS:</strong> Optimal zone is <strong>${iibsOpt.lead_bucket}</strong> leads × <strong>${iibsOpt.cpl_bucket}</strong> CPL &mdash; ` +
      `highest conv% ${iibsContactedFmt}, avg revenue ${fmtK(iibsOpt.avg_revenue)} (${iibsOpt.count} months). ` +
      `Bubble size reflects lead volume — larger bubbles = more leads that month.`;
  }

  // ===========================================================================
  // STANDARDS: 4-WAY OPTIMUM
  // ===========================================================================
  function render4WayOptimum() {
    const content = document.getElementById("standardsContent");

    // ── Helpers (shared with 3-way) ──
    function getCplBand4(cpl, school) {
      if (school === "Rosen") {
        if (cpl < 3.7)  return "Low (3.0–3.7)";
        if (cpl < 4.3)  return "Mid (3.7–4.3)";
        if (cpl < 5.0)  return "Sweet (4.3–5.0)";
    ...
    function getLeadBucket4(leads, school) {
      if (school === "Rosen") {
        if (leads < 2100) return "1800–2100";
        if (leads < 2400) return "2100–2400";
        if (leads < 2700) return "2400–2700";
    ...
    function heatColor4(val, maxVal) {
      const t = maxVal > 0 ? Math.min(val / maxVal, 1) : 0;
      if (t < 0.25) return { bg: "rgba(239,68,68,0.25)",  text: "#fca5a5" };
      if (t < 0.5)  return { bg: "rgba(245,158,11,0.25)", text: "#fcd34d" };
      if (t < 0.75) return { bg: "rgba(99,102,241,0.30)", text: "#a5b4fc" };
    ...
    // ── Compute 4-way data for one school ──
    function compute4Way(rows, school, leadBuckets, cplBuckets) {
      // Global normalization values
      const allRevs = rows.map(r => r.revenue);
      const allConts = rows.map(r => r.pct_contacted);
      const allEffs  = rows.map(r => r.rev_per_lead);
      const maxRev  = Math.max(...allRevs);
      const maxCont = Math.max(...allConts);
      const maxEff  = Math.max(...allEffs);

      const cells = [];
      leadBuckets.forEach(lb => {
        cplBuckets.forEach(cb => {
          const pts = rows.filter(r => getLeadBucket4(r.leads, school) === lb && getCplBand4(r.cpl, school) === cb);
          if (pts.length > 0) {
            const avgRev  = avg(pts.map(p => p.revenue));
            const avgCont = avg(pts.map(p => p.pct_contacted));
            const avgEff  = avg(pts.map(p => p.rev_per_lead));
            const score   = maxRev > 0 && maxCont > 0 && maxEff > 0
              ? (0.35 * avgRev / maxRev + 0.35 * avgCont / maxCont + 0.30 * avgEff / maxEff) * 100
              : 0;
            cells.push({ lead_bucket: lb, cpl_bucket: cb, avg_revenue: avgRev, avg_contacted: avgCont, rev_per_lead: avgEff, composite_score: score, count: pts.length });
          } else {
            cells.push({ lead_bucket: lb, cpl_bucket: cb, avg_revenue: 0, avg_contacted: 0, rev_per_lead: 0, composite_score: 0, count: 0 });
          }
        });
      });

      const opt = cells.filter(c => c.count > 0).reduce((b, c) => c.composite_score > b.composite_score ? c : b,
        { composite_score: -1, avg_revenue: 0, avg_contacted: 0, lead_bucket: "—", cpl_bucket: "—", count: 0 });

      // Tier summaries by CPL band
      const tiers = cplBuckets.map(cb => {
        const pts = rows.filter(r => getCplBand4(r.cpl, school) === cb);
        return {
          tier: cb,
          avg_revenue: pts.length ? avg(pts.map(p => p.revenue)) : 0,
          avg_contacted: pts.length ? avg(pts.map(p => p.pct_contacted)) : 0,
          rev_per_lead: pts.length ? avg(pts.map(p => p.rev_per_lead)) : 0,
          count: pts.length,
        };
      });

      return { cells, opt, tiers };
    }

    const rosenRows = CALL_STATS.rosen.map(m => ({
      school: "Rosen", month: m.short, leads: m.leads,
      cpl: m.calls / m.leads, pct_contacted: m.pct_contacted,
      revenue: m.net_sc, rev_per_lead: m.leads > 0 ? m.net_sc / m.leads : 0,
    }));
    const iibsRows = CALL_STATS.iibs.map(m => ({
      school: "IIBS", month: m.short, leads: m.leads,
      cpl: m.calls / m.leads, pct_contacted: m.conv,
      revenue: m.net_sc, rev_per_lead: m.leads > 0 ? m.net_sc / m.leads : 0,
    }));

    const rosenCplBuckets4 = ["Low (3.0–3.7)", "Mid (3.7–4.3)", "Sweet (4.3–5.0)", "High (5.0+)"];
    const iibsCplBuckets4  = ["Low (4.0–4.5)", "Mid (4.5–5.2)", "Sweet (5.2–5.8)", "High (5.8+)"];
    const rosenLeadBuckets4 = ["1800–2100", "2100–2400", "2400–2700", "2700–3000", "3000+"];
    const iibsLeadBuckets4  = ["4500–5500", "5500–6500", "6500–7500", "7500–8500", "8500+"];

    const r4 = compute4Way(rosenRows, "Rosen", rosenLeadBuckets4, rosenCplBuckets4);
    const i4 = compute4Way(iibsRows,  "IIBS",  iibsLeadBuckets4,  iibsCplBuckets4);

    const tierBandColors = [C.emerald, C.indigo, C.amber, C.red];

    content.innerHTML = `
      ${initKpiRow([
        { label: "Rosen Optimal Zone",      value: r4.opt.lead_bucket + " / " + r4.opt.cpl_bucket, sub: "Highest composite score", cls: "accent-green" },
        { label: "Rosen Composite Score",   value: r4.opt.composite_score.toFixed(0) + "/100",   sub: "35% Rev + 35% Contact + 30% Eff" },
        { label: "Rosen Avg Revenue",       value: fmtK(r4.opt.avg_revenue),                     sub: "In optimal zone" },
        { label: "IIBS Optimal Zone",       value: i4.opt.lead_bucket + " / " + i4.opt.cpl_bucket, sub: "Highest composite score", cls: "accent-green" },
        { label: "IIBS Composite Score",    value: i4.opt.composite_score.toFixed(0) + "/100",   sub: "35% Rev + 35% Contact + 30% Eff" },
      ])}

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">Rosen — Revenue &amp; Contact Rate by CPL Tier</div>
          <div class="chart-wrap" style="height:300px"><canvas id="std4dualR"></canvas></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">IIBS — Revenue &amp; Conv% by CPL Tier</div>
          <div class="chart-wrap" style="height:300px"><canvas id="std4dualI"></canvas></div>
        </div>
      </div>

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">Rosen — Composite Score Heatmap (Lead Band &times; CPL Band)</div>
          <div class="heatmap-container" id="std4heatR"></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">IIBS — Composite Score Heatmap (Lead Band &times; CPL Band)</div>
          <div class="heatmap-container" id="std4heatI"></div>
        </div>
      </div>

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">Rosen — Revenue vs %Contacted (colored by CPL band)</div>
          <div class="chart-wrap" style="height:300px"><canvas id="std4scatR"></canvas></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">IIBS — Revenue vs Conv% (colored by CPL band)</div>
          <div class="chart-wrap" style="height:300px"><canvas id="std4scatI"></canvas></div>
        </div>
      </div>

      <div class="verdict-banner">
        <div class="verdict-label">4-WAY OPTIMUM INSIGHT</div>
        <div class="verdict-text" id="std4insight"></div>
      </div>
    `;

    // ── Build composite heatmap HTML ──
    function buildCompositeHeatmap(cells, leadBuckets, cplBuckets, opt) {
      const maxScore = Math.max(...cells.filter(c => c.count > 0).map(c => c.composite_score), 0.001);
      let html = `<div style="overflow-x:auto"><table class="heatmap-table"><thead><tr><th>Leads \\ CPL</th>`;
      cplBuckets.forEach(cb => { html += `<th>${cb}</th>`; });
      html += `</tr></thead><tbody>`;
      leadBuckets.forEach(lb => {
        ...
        cplBuckets.forEach(cb => {
          const cell = cells.find(c => c.lead_bucket === lb && c.cpl_bucket === cb);
          if (cell && cell.count > 0) {
            const colors = heatColor4(cell.composite_score, maxScore);
            const isOpt = cell.lead_bucket === opt.lead_bucket && cell.cpl_bucket === opt.cpl_bucket;
            html += `<td class="heatmap-cell${isOpt ? " optimal" : ""}" style="background:${colors.bg};color:${colors.text}">
              <span class="cell-main">${cell.composite_score.toFixed(0)}</span>
              <span class="cell-sub">${fmtK(cell.avg_revenue)} &middot; ${cell.avg_contacted.toFixed(1)}%</span>
            </td>`;
          } else {
            html += `<td class="heatmap-cell" style="background:rgba(255,255,255,0.02);color:var(--color-text-tertiary)">
              <span class="cell-main">&mdash;</span>
              <span class="cell-sub">no data</span>
            </td>`;
          }
        });
        html += `</tr>`;
    ...
    document.getElementById("std4heatR").innerHTML = buildCompositeHeatmap(r4.cells, rosenLeadBuckets4, rosenCplBuckets4, r4.opt);
    document.getElementById("std4heatI").innerHTML = buildCompositeHeatmap(i4.cells, iibsLeadBuckets4,  iibsCplBuckets4,  i4.opt);

    // ── Dual-axis chart ──
    function makeDualAxis(result, canvasId, yLabel) {
      ...
      mkChart(canvasId, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Avg Revenue",
              data: tiers.map(t => t.avg_revenue),
              backgroundColor: C.indigoFade,
              borderColor: C.indigo,
              borderWidth: 1.5,
              borderRadius: barRadius,
            ...
            {
              label: yLabel,
              data: tiers.map(t => t.avg_contacted),
              type: "line",
              borderColor: C.emerald,
              backgroundColor: C.emeraldFade,
              borderWidth: 3,
        ...
        options: {
          ...
          maintainAspectRatio: false,
          interaction: { mode: "index", intersect: false },
          plugins: { legend: { display: true, labels: { color: C.textSec, font: { size: 10, family: "Inter" }, usePointStyle: true } }, tooltip: { ...baseTooltip } },
          scales: {
            x: { ...baseScaleX, title: { display: true, text: "CPL Tier", color: C.textMuted, font: { size: 10 } } },
            y: { ...baseScaleY("Avg Revenue"), position: "left", ticks: { ...baseScaleY("").ticks, callback: v => fmtK(v) } },
            y1: { position: "right", beginAtZero: true, grid: { display: false }, title: { display: true, text: yLabel, color: C.emerald, font: { size: 10 } }, ticks: { color: C.emerald, callback: v => v.toFixed(1) + "%" } },
          },
        },
      });
    }

    makeDualAxis(r4, "std4dualR", "Avg %Contacted");
    makeDualAxis(i4, "std4dualI", "Avg Conv%");

    // ── Scatter: Revenue vs Contact Rate, colored by CPL band ──
    function makeScatter4(rows, school, cplBuckets, canvasId, xLabel) {
      const bandColors = [C.emerald, C.indigo, C.amber, C.red];
      const datasets = cplBuckets.map((band, idx) => ({
        label: band,
        data: rows.filter(r => getCplBand4(r.cpl, school) === band).map(r => ({ x: r.pct_contacted, y: r.revenue, month: r.month, cpl: r.cpl, leads: r.leads })),
        backgroundColor: bandColors[idx] + "55",
        borderColor: bandColors[idx],
        borderWidth: 1.5,
        pointRadius: 5,
        pointHoverRadius: 8,
      ...
      mkChart(canvasId, {
        ...
        options: {
          ...
          plugins: {
            ...
            tooltip: {
              ...
              callbacks: {
                label: ctx => [
                  ctx.dataset.label,
                  `${xLabel}: ${ctx.raw.x.toFixed(1)}%`,
                  `Revenue: ${fmtK(ctx.raw.y)}`,
                  `CPL: ${ctx.raw.cpl.toFixed(2)}`,
                  `Month: ${ctx.raw.month}`,
                ],
              },
            },
          ...
          scales: {
            x: { ...baseScaleX, type: "linear", title: { display: true, text: xLabel, color: C.textMuted, font: { size: 10 } }, ticks: { ...baseScaleX.ticks, callback: v => v + "%" } },
            y: { ...baseScaleY("Net Revenue"), ticks: { ...baseScaleY("").ticks, callback: v => fmtK(v) } },
          },
        },
      });
    ...
    makeScatter4(rosenRows, "Rosen", rosenCplBuckets4, "std4scatR", "%Contacted");
    makeScatter4(iibsRows,  "IIBS",  iibsCplBuckets4,  "std4scatI", "Conv%");

    // ── Insight ──
    document.getElementById("std4insight").innerHTML =
      `<strong>Rosen:</strong> Composite score (35% Rev + 35% Contact + 30% Eff) peaks at ` +
      `<strong>${r4.opt.lead_bucket}</strong> leads × <strong>${r4.opt.cpl_bucket}</strong> CPL &mdash; ` +
      `score ${r4.opt.composite_score.toFixed(0)}/100, avg revenue ${fmtK(r4.opt.avg_revenue)}, contacted ${r4.opt.avg_contacted.toFixed(1)}%. &nbsp;` +
      `<strong>IIBS:</strong> Peaks at <strong>${i4.opt.lead_bucket}</strong> leads × <strong>${i4.opt.cpl_bucket}</strong> CPL &mdash; ` +
      `score ${i4.opt.composite_score.toFixed(0)}/100, avg revenue ${fmtK(i4.opt.avg_revenue)}, conv% ${i4.opt.avg_contacted.toFixed(2)}%. ` +
      `Scatter plots show revenue vs. contact/conversion rate by CPL band &mdash; look for the upper-right clusters.`;
  }

  // ===========================================================================
  // STANDARDS: TOP REVENUE MONTHS
  // ===========================================================================
  function renderTopRevMonths() {
    const content = document.getElementById("standardsContent");
    const TOP_N = 10;

    // ── Helpers ──
    function getCplBandTop(cpl, school) {
      if (school === "Rosen") {
        if (cpl < 3.7)  return "Low (3.0–3.7)";
        if (cpl < 4.3)  return "Mid (3.7–4.3)";
        if (cpl < 5.0)  return "Sweet (4.3–5.0)";
    ...
    const rosenRows = CALL_STATS.rosen.map(m => ({
      ...
      pct_contacted: m.pct_contacted,
      revenue: m.net_sc,
      rev_per_lead: m.leads > 0 ? m.net_sc / m.leads : 0,
    ...
    function computeStats(rows) {
      return {
        max_revenue: rows[0] ? rows[0].revenue : 0,
        max_month: rows[0] ? rows[0].month : "—",
        avg_revenue: avg(rows.map(r => r.revenue)),
        avg_cpl: avg(rows.map(r => r.cpl)),
        avg_contacted: avg(rows.map(r => r.pct_contacted)),
        avg_leads: Math.round(avg(rows.map(r => r.leads))),
      };
    }

    const rStats = computeStats(rosenRows);
    const iStats = computeStats(iibsRows);

    // ── CPL band distribution ──
    function bandDist(rows, school) {
      const dist = {};
      rows.forEach(r => {
        const b = getCplBandTop(r.cpl, school);
        dist[b] = (dist[b] || 0) + 1;
      });
      return dist;
    }
    // ── Avg revenue by band ──
    function bandRevenue(rows, school) {
      const map = {};
      rows.forEach(r => {
        const b = getCplBandTop(r.cpl, school);
        if (!map[b]) map[b] = [];
      ...
      return Object.entries(map).map(([band, pts]) => ({
        band,
        avg_revenue: avg(pts.map(p => p.revenue)),
        total_revenue: pts.reduce((s, p) => s + p.revenue, 0),
        avg_contacted: avg(pts.map(p => p.pct_contacted)),
        days: pts.length,
      }));
    }

    const rBandColors = { "Low (3.0–3.7)": C.emerald, "Mid (3.7–4.3)": C.indigo, "Sweet (4.3–5.0)": C.amber, "High (5.0+)": C.red };
    const iBandColors = { "Low (4.0–4.5)": C.emerald, "Mid (4.5–5.2)": C.indigo, "Sweet (5.2–5.8)": C.amber, "High (5.8+)": C.red };

    // ── Build data table HTML ──
    function buildTableHTML(rows, contactedLabel) {
      let html = `<div style="overflow-x:auto"><table class="heatmap-table" style="border-spacing:0;border-collapse:collapse">`;
      html += `<thead><tr style="background:rgba(255,255,255,0.04)">`;
      ["#", "Month", "Revenue", contactedLabel, "CPL", "Leads", "Rev/Lead"].forEach(h => {
        html += `<th style="padding:8px 12px;text-align:left;font-size:11px;font-weight:600;color:var(--color-text-secondary);text-transform:uppercase;letter-spacing:.06em;border-bottom:1px solid rgba(255,255,255,0.08)">${h}</th>`;
      });
      html += `</tr></thead><tbody>`;
      rows.forEach((r, idx) => {
        const rankColor = idx < 3 ? "#ffd60a" : "var(--color-text)";
        html += `<tr style="border-bottom:1px solid rgba(255,255,255,0.04)">
          <td style="padding:8px 12px;font-weight:700;color:${rankColor}">${r.rank}</td>
          <td style="padding:8px 12px;white-space:nowrap">${r.month}</td>
          <td style="padding:8px 12px;font-variant-numeric:tabular-nums">${fmtK(r.revenue)}</td>
          <td style="padding:8px 12px;font-variant-numeric:tabular-nums">${r.pct_contacted.toFixed(1)}%</td>
          <td style="padding:8px 12px;font-variant-numeric:tabular-nums">${r.cpl.toFixed(2)}</td>
          <td style="padding:8px 12px;font-variant-numeric:tabular-nums">${fmtNum(r.leads)}</td>
          <td style="padding:8px 12px;font-variant-numeric:tabular-nums">${fmtK(r.rev_per_lead)}</td>
        </tr>`;
      });
      html += `</tbody></table></div>`;
      return html;
    ...
    content.innerHTML = `
      ${initKpiRow([
        { label: "Rosen Record Month",    value: fmtK(rStats.max_revenue),           sub: rStats.max_month, cls: "accent-green" },
        { label: "Rosen Top-10 Avg Rev",  value: fmtK(rStats.avg_revenue),           sub: "Per month" },
        { label: "Rosen Top-10 Avg CPL",  value: rStats.avg_cpl.toFixed(2),          sub: "Calls per lead" },
        { label: "IIBS Record Month",     value: fmtK(iStats.max_revenue),           sub: iStats.max_month, cls: "accent-green" },
        { label: "IIBS Top-10 Avg Rev",   value: fmtK(iStats.avg_revenue),           sub: "Per month" },
      ])}

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">Rosen — Revenue vs %Contacted (by CPL band, top 10 months)</div>
          <div class="chart-wrap" style="height:300px"><canvas id="std5scatR"></canvas></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">IIBS — Revenue vs Conv% (by CPL band, top 10 months)</div>
          <div class="chart-wrap" style="height:300px"><canvas id="std5scatI"></canvas></div>
        </div>
      </div>

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">Rosen — Avg Revenue by CPL Band (top 10 months)</div>
          <div class="chart-wrap" style="height:260px"><canvas id="std5barR"></canvas></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">Rosen — CPL Band Distribution of Top 10 Months</div>
          <div class="chart-wrap" style="height:260px"><canvas id="std5dnutR"></canvas></div>
        </div>
      </div>

      <div class="chart-grid cols-2" style="margin-bottom:22px">
        <div class="chart-card">
          <div class="chart-card-title">IIBS — Avg Revenue by CPL Band (top 10 months)</div>
          <div class="chart-wrap" style="height:260px"><canvas id="std5barI"></canvas></div>
        </div>
        <div class="chart-card">
          <div class="chart-card-title">IIBS — CPL Band Distribution of Top 10 Months</div>
          <div class="chart-wrap" style="height:260px"><canvas id="std5dnutI"></canvas></div>
        </div>
      </div>

      <div class="chart-card" style="margin-bottom:22px">
        <div class="chart-card-title">Rosen — Top 10 Revenue Months</div>
        <div id="std5tableR"></div>
      </div>

      <div class="chart-card" style="margin-bottom:22px">
        <div class="chart-card-title">IIBS — Top 10 Revenue Months (Conv% shown)</div>
        <div id="std5tableI"></div>
      </div>

      <div class="verdict-banner">
        <div class="verdict-label">TOP REVENUE MONTHS INSIGHT</div>
        <div class="verdict-text" id="std5insight"></div>
      </div>
    `;

    // Inject tables
    document.getElementById("std5tableR").innerHTML = buildTableHTML(rosenRows, "%Contacted");
    document.getElementById("std5tableI").innerHTML = buildTableHTML(iibsRows,  "Conv%");

    // ── Scatter chart ──
    function makeTopScatter(rows, school, bandColors, canvasId, xLabel) {
      const bandKeys = Object.keys(bandColors);
      const datasets = bandKeys.map(band => ({
        label: band,
        data: rows.filter(r => getCplBandTop(r.cpl, school) === band)
              .map(r => ({ x: r.pct_contacted, y: r.revenue, cpl: r.cpl, leads: r.leads, month: r.month })),
        backgroundColor: bandColors[band] + "55",
    ...
    makeTopScatter(rosenRows, "Rosen", rBandColors, "std5scatR", "%Contacted");
    makeTopScatter(iibsRows,  "IIBS",  iBandColors, "std5scatI", "Conv%");

    // ── Bar: Avg Revenue by CPL band ──
    function makeTopBar(rows, school, bandColors, canvasId) {
      const bands = bandRevenue(rows, school);
      mkChart(canvasId, {
        type: "bar",
        data: {
          ...
          datasets: [{
            label: "Avg Revenue",
            data: bands.map(b => b.avg_revenue),
            backgroundColor: bands.map(b => (bandColors[b.band] || C.indigo) + "55"),
            borderColor: bands.map(b => bandColors[b.band] || C.indigo),
            borderWidth: 2,
            borderRadius: barRadius,
            barPercentage: 0.65,
          }],
        ...
        options: {
            ...
            tooltip: {
              ...
              callbacks: {
                label: ctx => {
                  ...
                  return [
                    `Avg Revenue: ${fmtK(b.avg_revenue)}`,
                    `Total: ${fmtK(b.total_revenue)}`,
                    `Months: ${b.days}`,
                  ];
                },
              },
          ...
          scales: {
            x: { ...baseScaleX },
            y: { ...baseScaleY("Avg Revenue"), ticks: { ...baseScaleY("").ticks, callback: v => fmtK(v) } },
          },
        },
      });
    }

    makeTopBar(rosenRows, "Rosen", rBandColors, "std5barR");
    makeTopBar(iibsRows,  "IIBS",  iBandColors, "std5barI");

    // ── Doughnut: CPL band distribution ──
    function makeTopDoughnut(rows, school, bandColors, canvasId) {
      const dist = bandDist(rows, school);
      const labels = Object.keys(dist);
      const values = Object.values(dist);
      const colors = labels.map(l => bandColors[l] || C.indigo);
      mkChart(canvasId, {
        type: "doughnut",
        data: {
          labels,
        ...
        options: {
          ...
          cutout: "60%",
          plugins: {
            legend: { display: true, position: "bottom", labels: { color: C.textSec, font: { size: 10, family: "Inter" }, padding: 12, usePointStyle: true } },
            tooltip: {
              ...baseTooltip,
              mode: "nearest",
              callbacks: {
                label: ctx => `${ctx.label}: ${ctx.raw} of ${TOP_N} months (${Math.round(ctx.raw / TOP_N * 100)}%)`,
              },
            },
          },
        },
    ...
    makeTopDoughnut(rosenRows, "Rosen", rBandColors, "std5dnutR");
    makeTopDoughnut(iibsRows,  "IIBS",  iBandColors, "std5dnutI");

    // ── Insight ──
    const rMidSweet = (bandDist(rosenRows, "Rosen")["Mid (3.7–4.3)"] || 0) + (bandDist(rosenRows, "Rosen")["Sweet (4.3–5.0)"] || 0);
    const iMidSweet = (bandDist(iibsRows,  "IIBS") ["Mid (4.5–5.2)"] || 0) + (bandDist(iibsRows,  "IIBS") ["Sweet (5.2–5.8)"] || 0);
    document.getElementById("std5insight").innerHTML =
      `<strong>Rosen Top 10:</strong> Record month ${rStats.max_month} at ${fmtK(rStats.max_revenue)}. ` +
      `Avg CPL ${rStats.avg_cpl.toFixed(2)}, avg %contacted ${rStats.avg_contacted.toFixed(1)}%, avg leads ${fmtNum(rStats.avg_leads)}. ` +
      `${rMidSweet} of ${TOP_N} top months fall in Mid/Sweet CPL bands. &nbsp;` +
      `<strong>IIBS Top 10:</strong> Record month ${iStats.max_month} at ${fmtK(iStats.max_revenue)}. ` +
      `Avg CPL ${iStats.avg_cpl.toFixed(2)}, avg conv% ${iStats.avg_contacted.toFixed(2)}%, avg leads ${fmtNum(iStats.avg_leads)}. ` +
      `${iMidSweet} of ${TOP_N} top months fall in Mid/Sweet CPL bands.`;
  }
